...
class CGenCode():
   ...
   def GenCode(self):
      ...
      PYTESTLISTFILE_RST = f"{REFERENCEPATH}/PEC_TestUsecases.rst"
      oPyTestListFile_RST = CFile(PYTESTLISTFILE_RST)
      print(f"* '{PYTESTLISTFILE_RST}'")

      PYTESTLISTFILE_TXT = f"{REFERENCEPATH}/PEC_TestUsecases.txt"
      oPyTestListFile_TXT = CFile(PYTESTLISTFILE_TXT)
      print(f"* '{PYTESTLISTFILE_TXT}'")

      PYTESTLISTFILE_CSV = f"{REFERENCEPATH}/PEC_TestUsecases.csv"
      oPyTestListFile_CSV = CFile(PYTESTLISTFILE_CSV)
      print(f"* '{PYTESTLISTFILE_CSV}'")

      PYTESTLISTFILE_HTML = f"{REFERENCEPATH}/PEC_TestUsecases.html"
...
<meta http-equiv="content-type" content="text/html; charset=windows-1252">
   <meta name="PythonExtensionsCollection" content="PythonExtensionsCollection">
   <title>PythonExtensionsCollection Test Overview</title>
</head>
...
<b>
PythonExtensionsCollection<br>Test Cases
</b></font>
</div>
<hr width="100%" color="#FF8C00" align="center">
