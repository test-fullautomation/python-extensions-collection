...
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), "./../PythonExtensionsCollection")))

# print("============================ (debug) sys.path:\n" + '\n'.join(sys.path))

# -- Project information -----------------------------------------------------

project = 'Python Extensions Collection'
copyright = '2022, Queckenstedt Holger (XC-CT/ECA3)'
author = 'Queckenstedt Holger (XC-CT/ECA3)'
...
latex_documents = [('index', 'Python-Extensions-Collection.tex', project, author, 'manual', False)]
