...
from PythonExtensionsCollection.version import VERSION   # ! here wee need the package name hard coded !
from PythonExtensionsCollection.version import VERSION_DATE # ! here wee need the package name hard coded !
