...
# Package renamed: python_extensions_collection -> PythonExtensionsCollection
#
...
class CConfig():
    ...
    def __init__(self, sReferencePath="."):
        ...
        # 1. basic setup stuff
        self.__dictConfig['sPackageName']                = "PythonExtensionsCollection"
        self.__dictConfig['sVersion']                    = "0.1.0"
        self.__dictConfig['sAuthor']                     = "XC-CI1/ECA3-Queckenstedt"
        self.__dictConfig['sAuthorEMail']                = "Holger.Queckenstedt@de.bosch.com"
        self.__dictConfig['sDescription']                = "This package provides a collection of additional Python functions"
        self.__dictConfig['sLongDescriptionContentType'] = "text/markdown"
        self.__dictConfig['sURL']                        = "https://sourcecode.socialcoding.bosch.com/projects/ROBFW/repos/python-extensions-collection/browse"
